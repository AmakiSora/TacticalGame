...
This skill teaches manual operation of the Hex multiplayer game (app version `3.1.8`). Think through each turn from the current state, choose legal actions, call the matching REST endpoint, then refresh state before deciding again.
